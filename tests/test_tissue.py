...
def test_tissue_tofts():
    ...
    ct = osipi.tofts(t, ca, Ktrans=0.6/60, ve=0.2)
    ...
    ca = osipi.aif_parker(t)
    ct = osipi.tofts(t, ca, Ktrans=0.6/60, ve=0.2, Ta=60.0)
    ...
    ca = osipi.aif_parker(t)
    ct_conv = osipi.tofts(t, ca, Ktrans=0.6/60, ve=0.2)
    ct_exp = osipi.tofts(t, ca, Ktrans=0.6/60, ve=0.2, discretization_method='exp')
