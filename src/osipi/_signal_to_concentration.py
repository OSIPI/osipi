...
def S_to_C_via_R1_SPGR(S: NDArray[np.float64], S_baseline: np.float64, R10: np.float64, TR: np.float64, a: np.float64, r1: np.float64) -> NDArray[np.float64]:
...
def S_to_R1_SPGR(S: NDArray[np.float64], S_baseline: np.float64, R10: np.float64, TR: np.float64, a: np.float64) -> NDArray[np.float64]:
