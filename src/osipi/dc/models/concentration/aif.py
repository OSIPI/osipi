...
def parker(t:np.ndarray, BAT:float=30.0, Hct:float=0.0, dose:float=0.1)->np.ndarray:
...
def georgiou(t:np.ndarray, BAT:float=30.0)->np.ndarray:
...
def weinmann(t:np.ndarray, BAT:float=30.0)->np.ndarray:
